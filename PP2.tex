...
Utilizzando i condensatori $C_1$ e $C_2$, scelti con capacità molto grandi al fine di aumentare il più possibile la banda passante dell'amplificatore, si introdurranno comunque delle frequenze di taglio
...
$f$ [\SI{}{Hz}] & $v_i$ [\SI{}{V}] & $v_o$ [\SI{}{V}] & $\abs{A_v}$ \\
\hline
...
\begin{tabular}{c|c|c}
$R_L$ [\SI{}{\ohm}] & $v_{R_L}$ [\SI{}{V}] & $R_\text{out}$ [\SI{}{\ohm}] \\
\hline
%INSERIRE TABELLA
...
\begin{tabular}{c|c|c|c}
$r_x$ [\SI{}{\ohm}] & $v_{i}$ [\SI{}{V}] &  $v_{2}$ [\SI{}{V}]  & $R_\text{in}$ [\SI{}{\ohm}] \\
\hline
%INSERIRE TABELLA
